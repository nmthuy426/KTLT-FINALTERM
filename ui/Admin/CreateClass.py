...
class Ui_AddClassDialog(object):
    def setupUi(self, AddClassDialog):
        ...
        self.label_2.setStyleSheet("color: rgb(0, 0, 90);\n"
"font: 5000 22pt \"Arial\";")
        ...
        self.label_24.setStyleSheet("font: 1000 10pt \"Cambria\";")
        ...
        self.lineEdit_ClassId.setMinimumSize(QtCore.QSize(0, 40))
...
"}")
        ...
        self.lineEdit_Subject.setMinimumSize(QtCore.QSize(0, 40))
...
"}")
        ...
        self.lineEdit_Schedule.setMinimumSize(QtCore.QSize(0, 40))
...
"}")
        ...
        self.lineEdit_Room.setMinimumSize(QtCore.QSize(0, 40))
...
"}")
        ...
        self.lineEdit_Major.setMinimumSize(QtCore.QSize(0, 40))
...
"}")
        ...
        self.pushButton_Back.setMaximumSize(QtCore.QSize(16777215, 55))
...
"}")
        ...
        self.pushButton_SaveClass.setMaximumSize(QtCore.QSize(16777215, 55))
