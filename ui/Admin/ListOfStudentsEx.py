...
from ui.Admin.ListOfStudents import Ui_Dialog  # Import UI từ file .ui đã convert

class ListOfStudentsWindow(QMainWindow, Ui_Dialog):
    ...
    def load_students(self):
        ...
        students = self.jff.read_data("dataset/students.json", dict) or []
